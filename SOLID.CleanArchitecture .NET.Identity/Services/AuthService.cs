...
namespace SOLID.CleanArchitecture_.NET.Identity.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<AuthResponse> Login(AuthRequest request)
        {
            ...
            if (user == null)
            {
                throw new NotFoundExceptions($"User with {request.Email} not found.", request.Email);
            }
        ...
        public async Task<RegisterationResponse> Register(RegistrationRequest request)
        {
